...
| Repository/application boundaries | `docs/phase-1-foundation/01-repository-and-application-boundaries.md` | `FND-001` proposed boundary map; documentation only, not an approved scaffold or Phase 1 GO |
