...
| Auth schema concept plan | `docs/phase-1-auth/` | Documentation-only conceptual entities, tenant isolation, sessions, RBAC, and future audit relationship; next step is an Auth schema approval gate, not implementation |
